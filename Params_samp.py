...
def parse_args():
    ...
    parser.add_argument('--decoder', default='sesg', type=str, help='type of encoder, selected from bilinear, shared_bottom, mmoe, ple, sesg')
    ...
    parser.add_argument('--graphSampleN', default=40000, type=int, help='use 25000 for training and 200000 for testing, empirically')
